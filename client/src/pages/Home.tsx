...
export default function Home() {
  ...
  return (
    <>
      ...
      <AudioPlayer config={profile.audio} />

      <main className="min-h-screen py-8 px-4 flex flex-col items-center justify-start relative z-10 overflow-y-auto gap-4">
        ...
        >
          ...
          >
            ...
            <div className="px-5 pb-5 -mt-10 relative z-10">
              ...
              {/* Bio Tags */}
              <motion.div variants={item} className="flex flex-wrap gap-1 mb-5">
                {bioTags.map((tag, i) => (
        ...
        <div className="w-full max-w-[320px] space-y-3">
          ...
          <motion.div 
            ...
            className="glass-panel rounded-[1.5rem] p-4 flex items-center justify-between bg-[#1a1a1a]/80 backdrop-blur-xl border border-white/5 shadow-xl"
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl overflow-hidden shadow-lg bg-[#2b2d31]">
                {profile.discord.serverId ? (
                  <img 
                    src={`https://api.lanyard.rest/v1/guild/${profile.discord.serverId}/icon`} 
                    alt="Server Icon"
